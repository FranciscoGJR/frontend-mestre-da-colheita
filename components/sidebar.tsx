  ...
  return (
    <div className="hidden md:flex md:flex-col md:w-64 md:fixed md:inset-y-0 bg-green-700 z-10">
      <div className="flex flex-col flex-grow pt-5 overflow-y-auto">
        <div className="flex items-center flex-shrink-0 px-4 flex-col">
          <img
            src="/small-imgs/logo.png"
            alt="Logo"
            className="w-full h-16 mb-4"
          />
          <h1 className="text-xl text-center font-bold text-white">Mestre da Colheita</h1>
        </div>
